...
(vnet-enb-*) - for example a corporate network already peered/routed to the VNet, or a temporary
jump box/Azure Bastion host on the same VNet. See docs/azd-deployment.md for details.
