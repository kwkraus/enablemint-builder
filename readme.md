...
- **Session registration links** — Attach an optional registration URL to any session; links open in a new tab from the series list and session details, and are included in markdown exports when present.
